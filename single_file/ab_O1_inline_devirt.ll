...
define i32 @main() local_unnamed_addr #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = call noalias nonnull dereferenceable(16) i8* @_Znwm(i64 16) #6
  %2 = bitcast i8* %1 to %class.B*
  %3 = call i8* @llvm.launder.invariant.group.p0i8(i8* nonnull %1)
  %4 = bitcast i8* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV1A, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %4, align 8, !tbaa !13, !invariant.group !16
  %5 = call i8* @llvm.strip.invariant.group.p0i8(i8* nonnull %1)
  %6 = getelementptr inbounds i8, i8* %5, i64 8
  %7 = bitcast i8* %6 to i32*
  store i32 3, i32* %7, align 8, !tbaa !17
  %8 = getelementptr inbounds %class.B, %class.B* %2, i64 0, i32 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV1B, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %8, align 8, !tbaa !13, !invariant.group !16
  %9 = getelementptr inbounds i8, i8* %5, i64 12
  %10 = bitcast i8* %9 to i32*
  store i32 4, i32* %10, align 4, !tbaa !21
  %11 = call i1 @llvm.type.test(i8* bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV1B, i64 0, inrange i32 0, i64 2) to i8*), metadata !"_ZTS1A")
  call void @llvm.assume(i1 %11)
  call void @_ZN1B3fooEv(%class.B* nonnull align 8 dereferenceable(12) %2)
  ret i32 0
}
...
attributes #5 = { inaccessiblememonly nofree nosync nounwind speculatable willreturn }
