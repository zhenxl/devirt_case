...
define i32 @main() local_unnamed_addr #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = tail call noalias nonnull dereferenceable(16) i8* @_Znwm(i64 16) #9
...
3:                                                ; preds = %0
  ...
  %7 = tail call i1 @llvm.type.test(i8* bitcast (i8** getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @_ZTV1B, i64 0, inrange i32 0, i64 2) to i8*), metadata !"_ZTS1A")
...
define linkonce_odr void @_ZN1BC1Ei(%class.B* nonnull align 8 dereferenceable(16) %0, i32 %1) unnamed_addr #2 align 2 {
  tail call void @_ZN1BC2Ei(%class.B* nonnull align 8 dereferenceable(16) %0, i32 %1)
  ret void
}
...
define linkonce_odr void @_ZN1BC2Ei(%class.B* nonnull align 8 dereferenceable(16) %0, i32 %1) unnamed_addr #2 align 2 {
  ...
  %4 = tail call i8* @llvm.launder.invariant.group.p0i8(i8* nonnull %3)
  %5 = bitcast i8* %4 to %class.A*
  tail call void @_ZN1AC2Ev(%class.A* nonnull align 8 dereferenceable(12) %5)
  ...
  %7 = tail call i8* @llvm.strip.invariant.group.p0i8(i8* nonnull %3)
...
define linkonce_odr void @_ZN1AC2Ev(%class.A* nonnull align 8 dereferenceable(12) %0) unnamed_addr #8 align 2 {
  ...
  %4 = tail call i8* @llvm.strip.invariant.group.p0i8(i8* nonnull %3)
